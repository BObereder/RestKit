...
/**
 Sets the `modificationAttributes` to the receiver to the attribute with the specified names.
 
 The given array of names must correspond to the names of attributes within the receiver's entity.
 
 @param attributeNames Array of names of attributes in the entity of the receiver.
 @raises NSInvalidArgumentException Raised if no attribute could be found with any of the the given names.
 */
...
@property (nonatomic, copy) NSString *modificationKey DEPRECATED_ATTRIBUTE_MESSAGE("Use `setModificationAttributesForNames:` instead");
